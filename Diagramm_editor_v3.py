...
class DiagramEditor(tk.Tk):
    def __init__(self):
        super().__init__()
        self.title("Diagramm-Editor V3 PRO")
        ...
        self.box_templates = [
            {"name": "KNX", "color": "green", "shape": "oval"},
            {"name": "Loxone", "color": "lightblue", "shape": "rectangle"},
            {"name": "Modbus", "color": "orange", "shape": "diamond"},
            {"name": "IP", "color": "red", "shape": "oval"},
        ]
